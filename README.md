...
Run the following from the ui-remote-storage directory to serve your new app using a development server:
```
stripes serve
```
...
See project [UIRS](https://issues.folio.org/browse/UIRS)
